...
export function Header() {
  ...
  return (
    <header className="flex flex-col gap-2 border-b border-white/[0.05] pb-4">
      <div className="flex items-center justify-between">
        <div className="flex flex-col gap-2">
          <span className="font-serif text-xs tracking-widest text-[#C5A059] uppercase font-medium">
            Liturgia Diária
          </span>
          <h1 className="text-xl md:text-3xl font-bold tracking-tight text-white font-serif capitalize">
            {currentDate}
          </h1>
        </div>
